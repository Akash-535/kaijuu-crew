...
const AboutUsSection = () => {
    return (
        <>
            <div className='bg-[#001120] pb-28 max-xl:pb-20 max-lg:pb-16 max-md:pb-14 max-sm:pb-8'>
                <div className="container">
                    <div className='flex gap-10 max-lg:flex-col'>
                        <div className='w-6/12 pt-28 max-lg:w-full'>
                            <CommonHeading commonHeading="ABOUT" headingSpan="US" />
                            <div className='pb-8 pt-7'>   <CommonDescription commonDescription="It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged." /></div>
                            <div>
                                <CommonButton commonButton="MINT NFT" />
                            </div>
                        </div>
                        <div className="w-6/12 ps-9 pt-14 max-lg:w-full max-lg:ps-0 max-lg:pt-0">
                            <div>
